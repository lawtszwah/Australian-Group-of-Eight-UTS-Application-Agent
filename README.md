...
731 个项目，来自两校 handbook：

| 学校 | handbook 年份 | 项目数 |
|---|---|---|
| Monash University | 2026 | 459 |
| UNSW Sydney | 2027 | 272 |
...
**每校只保留最新一个年份的 handbook。** 各校 sitemap 同时挂着多年份页面，
早已停办的项目只存在于旧年份里。上一版数据集混入了 2019–2025 年的页面，
共 160 个停办项目，已全部清除——给申请人推荐一个几年前就停办的项目是严重错误。
...
| `handbook_year` | 该条数据来自哪一年的 handbook |
